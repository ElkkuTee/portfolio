...
const fiTranslations: Translations = {
  ...
  projects: {
    title: 'Projektit',
    featuredTitle: 'Parkour Notborn',
    featuredBadge: 'Pelattava WebGL-projekti',
    featuredDesc: 'Nopeatempoinen parkour incremental -peli, jossa liike, tempo ja toistettavuus ovat keskiössä.',
    featuredNote: 'Unity WebGL upotettuna responsiivisesti 16:9-suhteella.',
    featuredFullscreen: 'Avaa koko näytolle',
    featuredOpen: 'Avaa omaan valilehteen',
...
const enTranslations: Translations = {
  ...
  projects: {
    title: 'Projects',
    featuredTitle: 'Parkour Notborn',
    featuredBadge: 'Playable WebGL Project',
    featuredDesc: 'A high-speed parkour incremental focused on momentum, responsiveness, and replayable movement.',
    featuredNote: 'Unity WebGL embedded responsively in a fixed 16:9 frame.',
    featuredFullscreen: 'Launch Fullscreen',
    featuredOpen: 'Open Standalone',
